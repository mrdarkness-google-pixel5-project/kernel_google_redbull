				     ...
				     void *data, size_t len, uint8_t *ecc)
{
	...
	return decode_rs8(prz->rs_decoder, data, prz->ecc_info.par, len, NULL,
			  0, NULL, 0, NULL);
}
				   ...
				   struct persistent_ram_ecc_info *ecc_info)
{
	...
	prz->ecc_info.par = kmalloc_array(
		prz->ecc_info.ecc_size, sizeof(*prz->ecc_info.par), GFP_KERNEL);
	if (!prz->ecc_info.par) {
...
persistent_ram_new(phys_addr_t start, phys_addr_t alt_start, size_t size,
